    ...
    <div class="beg-login-main">
        <form action="/manage/login" class="layui-form" method="post"><input name="__RequestVerificationToken"
            ...
            <div class="layui-form-item">
                ...
                <input type="text" name="userName" lay-verify="userName" autocomplete="off" placeholder="这里输入用户名"
            ...
            <div class="layui-form-item">
                ...
                <div class="beg-pull-left">
                    <button class="layui-btn layui-btn-primary" lay-submit lay-filter="register" type="reset">
