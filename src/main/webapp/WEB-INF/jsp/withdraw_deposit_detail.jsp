...
<div class="layui-form-item">
    <div class="layui-inline a">
        <div class="s">
            ...
            <div class="layui-inline">
                <div class="layui-input-block">
                    <input type="text" name="date" id="beginDate" lay-verify="date" placeholder="yyyy-mm-dd"
        ...
        <div class="s">
            <div class="layui-inline">
                <div class="layui-input-block">
                    <input type="text1" name="date" id="endDate" lay-verify="date" placeholder="yyyy-mm-dd"
                           autocomplete="off" class="layui-input" onclick="layui.laydate({elem: this})">
                </div>
            </div>
        </div>
...
<script>
    ...
    function ajaxQuery(thisPage) {
        $.ajax({
            ...
            data: {beginDate: $(".beginDate").val(), endDate: $(".endDate").val(), thisPage: thisPage,type:"提现"},
            dataType: "json",
            type: "post",
